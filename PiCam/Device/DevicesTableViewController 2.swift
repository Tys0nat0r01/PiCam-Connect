//
//  DevicesTableViewController 2.swift
//  PiCam
//
...
class DevicesConnectTableViewController: UITableViewController {
    ...
    private func setupUI() {
        ...
        emptyLabel.text = "No devices found."
    ...
    private func parseSnapshot(_ snapshot: QuerySnapshot?) {
        ...
        DispatchQueue.main.async {
            ...
            self.emptyLabel.isHidden = !self.devices.isEmpty
        }
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "DeviceCell2", for: indexPath) as! DeviceCell2
